...
sentimentos %>% mutate(insatisfacao = case_when(sentimentos$polaridade  < -6 ~ 5, sentimentos$polaridade < -1 ~ 4 , sentimentos$polaridade  < 4 ~ 3, 
                                     sentimentos$polaridade  < 9 ~ 2, sentimentos$polaridade  >= 9 ~ 1))

sentimentos %>% write_csv(here("data/5-sentimentos/sentimento.csv"))
```
